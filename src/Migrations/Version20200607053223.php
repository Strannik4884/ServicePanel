 ...
 */
final class Version20200607053223 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE document (id INT NOT NULL, src_rtf VARCHAR(255) NOT NULL, src_html VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
